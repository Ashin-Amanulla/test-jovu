...
@InputType()
class AppointmentCreateNestedManyWithoutCounselorsInput {
...
export { AppointmentCreateNestedManyWithoutCounselorsInput as AppointmentCreateNestedManyWithoutCounselorsInput };
